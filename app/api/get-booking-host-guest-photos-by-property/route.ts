...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error('Error getting booking host guest photos by property:', error);
    return new Response('Error getting booking host guest photos by property', { status: 500 });
  }
}